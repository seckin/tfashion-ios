...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.containerView = [[UIView alloc] initWithFrame:CGRectMake( 0.0f, 0.0f, self.bounds.size.width, 6.0f)];
        ...
        bottomBorder.frame = CGRectMake(0, 5, CGRectGetWidth(self.containerView.frame), 1);
        [self.containerView.layer addSublayer:bottomBorder];

        [self addSubview:self.containerView];
        [self.containerView setBackgroundColor:[UIColor colorWithRed:80/255.0f green:80/255.0f blue:80/255.0f alpha:0.5]];
    }
