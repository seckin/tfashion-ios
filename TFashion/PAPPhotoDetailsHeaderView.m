...
- (void)createView {    
    ...
    [self.photographer fetchIfNeededInBackgroundWithBlock:^(PFObject *object, NSError *error) {
        ...
        [userButton setTitleColor:[UIColor darkGrayColor] forState:UIControlStateNormal];
        [userButton setTitleColor:[UIColor lightGrayColor] forState:UIControlStateHighlighted];
